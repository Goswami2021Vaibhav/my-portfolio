        ...
        <header className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-24">
          <div className="lg:col-span-8">
            ...
            >
              ...
              scalable web applications, ERP systems, and e-commerce platforms
              from concept to deployment. I focus on delivering clean,
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div
                  key={i}
                  className="p-5 rounded-[2rem] bg-zinc-900/20 border border-zinc-800 text-center hover:border-accent/30 transition-colors"
                >
              ...
              >
                ...
                <div className="flex flex-wrap gap-2">
                  {group.items.map((item, j) => (
                    <span
                      key={j}
                      className="px-3 py-1.5 rounded-lg bg-zinc-900/60 border border-zinc-800 text-zinc-300 text-xs font-bold"
                    >
                      {item}
                    </span>
                  ))}
        ...
        <section className="mb-24 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            ...
            <div className="flex items-start gap-4">
              <div className="text-5xl font-display font-black text-accent shrink-0">
                6×
              </div>
              <div>
                <h3 className="text-lg font-bold text-foreground mb-1">
                ...
                <p className="text-zinc-500 text-sm">
                  Awarded 6 times at Digicrowd Solution for consistent delivery
                  and impact.
                </p>
              </div>
            </div>
