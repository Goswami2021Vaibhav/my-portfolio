...
import { Download, ArrowRight, Zap, Briefcase } from "lucide-react";
...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden bg-background">
      ...
      {/* Ambient glows */}
      <div
        className="absolute top-0 left-0 w-[600px] h-[600px] rounded-full pointer-events-none -translate-x-1/2 -translate-y-1/2"
        style={{
          background:
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col">
            ...
            >
              ...
              <span className="text-muted text-xs font-body tracking-wide uppercase">
            ...
            >
              ...
              , ERP systems, AI-powered platforms, and e-commerce solutions
            ...
            >
              <Link
                href="/work"
                className="inline-flex items-center gap-2 bg-accent hover:bg-accent-hover text-background font-body font-bold text-sm md:px-8 md:py-4 px-6 py-3 rounded-full transition-all hover:scale-105 active:scale-95 shadow-lg shadow-accent/20"
              >
            ...
            >
              {stats.map((stat, i) => (
                <div key={i} className="flex md:justify-start justify-center">
                  <div>
                    <div className="font-display font-black text-3xl text-accent md:text-start text-center">
                      {stat.value}
                    </div>
                    <div className="font-body text-muted text-[10px] uppercase tracking-widest mt-1 md:text-start text-center">
                      {stat.label}
                    </div>
                  </div>
                </div>
            ...
            <div className="relative group">
              ...
              <div className="relative md:w-[400px] md:h-[450px] w-[350px] h-[400px] rounded-[48px] bg-surface/40 backdrop-blur-md border border-border/50 overflow-hidden flex flex-col items-center justify-center p-10 transition-all group-hover:border-accent/40 shadow-2xl">
                ...
                <div className="flex items-center gap-3 bg-background/60 border border-border/50 rounded-2xl px-5 py-2.5 backdrop-blur-sm">
                  ...
                  <span className="font-body text-muted text-xs font-medium">
                    20+ projects shipped
                  </span>
                </div>
              </div>
