            ...
            <div class="col-12 p-0 mt-4">
                <div class="card">
                    <div class="card-header border-bottom">
                        <h6 class="text-primary" style="font-size: 16px">Edit Portfolio</h6>
                    </div>
                    <div class="card-body">

                        <form method="POST" id="Portfolio-form"
                            onsubmit="uploadData2('Portfolio-form','{{ route('admin.updatePortfolio', $data->id) }}', 'alert-box', 'btn-box-1', event)"
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input type="text" name="title" class="form-control" required
                                        placeholder="Enter Portfolio Title" value="{{ $data->title }}">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <textarea name="des"   class="form-control">{{ $data->des }}</textarea>
                                    <p class="form-feedback invalid-feedback" data-name="des"></p>
                                </div>
                                <div class="col-lg-12 mb-3">
                                    <label class="form-label"> Content</label>
                                    <textarea name="content" id="editor" cols="30" rows="10" class="form-control">@php
